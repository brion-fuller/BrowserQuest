...
import { FormatChecker, check } from "./format";
import * as Types from "../../shared/ts/gametypes";
import Character from "./character";
import Chest from "./chest";

export default class Player extends Character {
  zone_callback: Function;
  weaponLevel: Function;
  armorLevel: Function;
  armor: Function;
  id: any;
  server: any;
    ...
    this.connection.listen(function (message) {
      ...
      if (action === Types.Messages.HELLO) {
        ...
        if (item) {
          ...
          if (Types.isItem(kind)) {
            ...
            if (kind === Types.Entities.FIREPOTION) {
              ...
              self.send(new HitPoints(self.maxHitPoints).serialize());
        ...
        if (self.server.isValidPosition(x, y)) {
          ...
          self.broadcast(new Teleport(self));
  ...
  equipItem(item) {
    if (item) {
      ...
      if (Types.isArmor(item.kind)) {
        ...
        this.send(new HitPoints(this.maxHitPoints).serialize());
